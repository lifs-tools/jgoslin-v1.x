 ...
 */
@Slf4j
public class SwissLipidsNamesTest {
    ...
    public void isValidSwissLipidsName(String lipidMapsName) throws ParsingException {
        ...
        log.info("Parsing SwissLipids identifier: {}", lipidMapsName);
