...
public class IsomericSubspeciesLcbHandler {
    ...
    public Optional<LipidSpecies> visitIsomericSubspeciesLcb(String headGroup, HMDBParser.LcbContext lcbContext, List<HMDBParser.FaContext> faContexts) {
    ...
    public FattyAcid buildIsomericLcb(String headGroup, HMDBParser.LcbContext ctx, String faName, int position) {
