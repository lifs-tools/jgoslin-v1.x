...
public class MolecularSubspeciesFasHandler {
    ...
    public Optional<LipidSpecies> visitMolecularSubspeciesFas(String headGroup, List<HMDBParser.FaContext> faContexts) {
    ...
    public FattyAcid buildMolecularFa(String headGroup, HMDBParser.FaContext ctx, String faName) {
