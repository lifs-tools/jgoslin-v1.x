...
public class IsomericSubspeciesFasHandler {
    ...
    public Optional<LipidSpecies> visitIsomericSubspeciesFas(String headGroup, List<HMDBParser.FaContext> faContexts) {
    ...
    public FattyAcid buildIsomericFa(String headGroup, HMDBParser.FaContext ctx, String faName, int position) {
