...
public class StructuralSubspeciesFasHandler {
    ...
    public Optional<LipidSpecies> visitStructuralSubspeciesFas(String headGroup, List<HMDBParser.FaContext> faContexts) {
    ...
    public FattyAcid buildStructuralFa(String headGroup, HMDBParser.FaContext ctx, String faName, int position) {
