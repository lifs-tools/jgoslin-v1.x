...
public class MolecularSubspeciesFasHandler {
    ...
    public Optional<LipidSpecies> visitMolecularSubspeciesFas(String headGroup, List<GoslinParser.FaContext> faContexts) {
    ...
    public MolecularFattyAcid buildMolecularFa(String headGroup, GoslinParser.FaContext ctx, String faName) {
