...
public enum LipidClass {
    ...
    FA_10_HDOHE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "10-HDoHE"),
    FA_11_HDOHE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "11-HDoHE"),
    FA_11_HETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "11-HETE"),
    FA_11_12_DHET(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "11,12-DHET", "11,12-DiHETrE"),
    FA_11_12_EET(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "11(12)-EET", "11,12-EpETrE"),
    FA_12_HEPE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "12-HEPE"),
    FA_12_HETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "12-HETE"),
    FA_12_HHTRE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "12-HHTrE"),
    FA_12_OXOETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "12-OxoETE"),
    FA_12_13_EPOME(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "12(13)-EpOME"),
    FA_13_HODE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "13-HODE"),
    FA_13_HOTRE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "13-HOTrE"),
    FA_14_15_DHET(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "14,15-DHET", "14,15-DiHETrE"),
    FA_14_15_EET(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "14(15)-EET", "14,15-EpETrE"),
    FA_14_15_EPETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "14(15)-EpETE"),
    FA_15_HEPE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "15-HEPE"),
    FA_15_HETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "15-HETE"),
    FA_15D_PGJ2(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "15d-PGJ2"),
    FA_16_HDOHE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "16-HDoHE"),
    FA_16_HETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "16-HETE"),
    FA_18_HEPE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "18-HEPE"),
    FA_5_HEPE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "5-HEPE"),
    FA_5_HETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "5-HETE"),
    FA_5_HPETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "5-HpETE"),
    FA_5_OXOETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "5-OxoETE"),
    FA_5_12_DIHETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "5,12-DiHETE"),
    FA_5_6_DIHETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "5,6-DiHETE"),
    FA_5_6_15_LXA4(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "5,6,15-LXA4"),
    FA_5_6_EET(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "5(6)-EET", "5,6-EpETrE"),
    FA_8_HDOHE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "8-HDoHE"),
    FA_8_HETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "8-HETE"),
    FA_8_9_DHET(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "8,9-DHET", "8,9-DiHETrE"),
    FA_8_9_EET(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "8(9)-EET", "8,9-EpETrE"),
    FA_9_HEPE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "9-HEPE"),
    FA_9_HETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "9-HETE"),
    FA_9_HODE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "9-HODE"),
    FA_9_HOTRE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "9-HOTrE"),
    FA_9_10_EPOME(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "9(10)-EpOME"),
    AA(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "AA", "Arachidonic acid", "Arachidonic acid"),
    ALPHA_LA(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "alpha-LA"),
    DHA(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "DHA", "Docosapentaenoic acid"),
    EPA(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "EPA", "Eicosapentaenoic acid"),
    GP_NAE(LipidCategory.FA, "X-ethanolamine", "GP-NAE"),
    LINOLEIC_ACID(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "Linoleic acid"),
    LTB4(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "LTB4"),
    LTC4(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "LTC4"),
    LTD4(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "LTD4"),
    MARESIN_1(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "Maresin 1"),
    NAE(LipidCategory.FA, "X-ethanolamine", "NAE"),
    PALMITIC_ACID(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "Palmitic acid"),
    PGB2(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "PGB2"),
    PGD2(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "PGD2"),
    PGE2(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "PGE2"),
    PGF2ALPHA(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "PGF2alpha"),
    PGI2(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "PGI2"),
    RESOLVIN_D1(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "Resolvin D1"),
    RESOLVIN_D2(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "Resolvin D2"),
    RESOLVIN_D3(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "Resolvin D3"),
    RESOLVIN_D5(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "Resolvin D5"),
    TETRANOR_12_HETE(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "tetranor-12-HETE"),
    TXB1(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "TXB1"),
    TXB2(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "TXB2"),
    TXB3(LipidCategory.FA, "Fatty acids and conjugates [FA01]", "TXB3"),
    ...
    SHEXCER(LipidCategory.SP, "Acidic glycosphingolipids [SP06]", "SHexCer", "SulfoHexCer", "(3'-sulfo)Galbeta-Cer", "(3'-sulfo)Galβ-Cer"),
