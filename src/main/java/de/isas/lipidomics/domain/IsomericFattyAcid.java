...
public class IsomericFattyAcid extends StructuralFattyAcid {
    ...
    public IsomericFattyAcid(String name, int position, int nCarbon, int nHydroxy, Map<Integer, String> doubleBondPositions) {
        super(name, position, nCarbon, nHydroxy, doubleBondPositions.size());
