...
//        LipidMapsParser.LipidContext lipid = ctx.lipid_rule();
...
//    private static class LipidVisitor extends LipidMapsBaseVisitor<Lipid> {
//
//        @Override
//        public Lipid visitLipid_pure(LipidMapsParser.Lipid_pureContext ctx) {
//            Lipid lipid = null;
...
//        }
//
//        private void visitFas(List<LipidMapsParser.FaContext> faContexts, Lipid lipid) {
...
//    }
//
//    private static class FaVisitor extends LipidMapsBaseVisitor<FattyAcid> {
//
//        @Override
//        public FattyAcid visitFa(LipidMapsParser.FaContext ctx) {
//            if (ctx.ether() != null) {
